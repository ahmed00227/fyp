 ...
 <div class="container">
    <div class="row">
        <div class="col-lg-8">
         ...
         <h4> The store aims to create a seamless shopping experience for its customers, with high-quality products <br>and expert support readily available online.</h4>
         </div>
